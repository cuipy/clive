document.write(
    ...
    +'</div>'
    +'<div class="hides " id="buy-1" data-group="1" style="margin-right: -143px;cursor: pointer;width: 112px;background-color: #A7D2A9;height: 47px;margin-left: 47px;border: 1px solid #8BC48D;text-align: center;line-height: 47px;">'
    ...
    +'<img src='+dqurl+'/static/demo/images/ll04.png style="float: right;border: 0;cursor: pointer;">'
    +'</div>'
    +'<div class="hides " id="buy-2" data-group="2" style="margin-right: -143px;cursor: pointer;width: 112px;background-color: #A7D2A9;height: 47px;margin-left: 47px;border: 1px solid #8BC48D;text-align: center;line-height: 47px;">'
