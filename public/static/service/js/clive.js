...
$(function () {
    ...
    $("#face").click(function (e) {
        ...
        layui.use(['layer'], function () {
            ...
            var isShow = $(".layui-clive-face").css('display');
            if ('block' == isShow) {
                layer.close(index);
                return;
            }
...
function showFaces() {
    ...
    var _html = '<div class="layui-clive-face"><ul class="layui-clear clive-face-list">';
...
function msgFactory(content, type, uinfo) {
    ...
    _html += '</div><div class="clive-chat-text">' + replaceContent(content) + '</div>';
    _html += '</li>';
